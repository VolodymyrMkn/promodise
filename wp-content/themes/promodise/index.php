    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 d-none d-lg-block col-sm-12">
                <div class="intro-img">
                    <img src="<?php bloginfo('template_url')?>/images/banner/why-choose.png" alt="intro-img" class="img-fluid" />
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    <div class="service-img-icon">
                        <img src="<?php bloginfo('template_url')?>/images/icon/007-digital-marketing-3.png" alt="service-icon" class="img-fluid" />
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    <div class="service-img-icon">
                        <img src="<?php bloginfo('template_url')?>/images/icon/008-digital-marketing-2.png" alt="service-icon" class="img-fluid" />
                    </div>
                    <div class="service-inner">
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    <div class="service-img-icon">
                        <img src="<?php bloginfo('template_url')?>/images/icon/003-task.png" alt="service-icon" class="img-fluid" />
                    </div>
                    <div class="service-inner">
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    <div class="service-img-icon">
                        <img src="<?php bloginfo('template_url')?>/images/icon/010-digital-marketing.png" alt="service-icon" class="img-fluid" />
                    </div>
                    <div class="service-inner">
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    <div class="service-img-icon">
                        <img src="<?php bloginfo('template_url')?>/images/icon/006-analytics.png" alt="service-icon" class="img-fluid" />
                    </div>
                    <div class="service-inner">
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    <div class="service-img-icon">
                        <img src="<?php bloginfo('template_url')?>/images/icon/004-hiring.png" alt="service-icon" class="img-fluid" />
                    </div>
                    <div class="service-inner">
                                    ...
                                    <div class="testimonial-content style-2">
                                        <div class="author-info">
                                            <div class="author-img">
                                                <img src="<?php bloginfo('template_url')?>/images/author/3b.jpg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12">
                                    <div class="testimonial-content style-2">
                                        <div class="author-info">
                                            <div class="author-img">
                                                <img src="<?php bloginfo('template_url')?>/images/author/5b.jpg" alt="" class="img-fluid" />
                                            </div>
                                        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 col-md-4">
                <div class="blog-block">
                    <img src="<?php bloginfo('template_url')?>/images/blog/blog-1.jpg" alt="" class="img-fluid" />
                    <div class="blog-text">
            ...
            <div class="col-lg-4 col-sm-6 col-md-4">
                <div class="blog-block">
                    <img src="<?php bloginfo('template_url')?>/images/blog/blog-2.jpg" alt="" class="img-fluid" />
                    <div class="blog-text">
            ...
            <div class="col-lg-4 col-sm-6 col-md-4">
                <div class="blog-block">
                    <img src="<?php bloginfo('template_url')?>/images/blog/blog-3.jpg" alt="" class="img-fluid" />
                    <div class="blog-text">
